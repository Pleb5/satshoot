<script lang="ts">
    ...
    const action = $derived(props.toast.action);
</script>
...
>
    ...
    <div class="{props.messageBase} {props.messageClasses}" data-testid="toast-message">
        ...
        <span
            ...
            {...api.getTitleProps()}
            data-testid="toast-title">{api.title}</span
        >
        <!-- Description -->
        <span
            class="{props.descriptionBase} {props.descriptionClasses}"
            {...api.getDescriptionProps()}
            data-testid="toast-description">{api.description}</span
        >
    </div>
    ...
    <div class="flex items-center space-x-2">
        ...
        {#if api.closable}
            <!-- Dismiss Button -->
            <button
                class="btn-icon btn-icon-sm preset-filled {props.btnDismissBase} {props.btnDismissClasses}"
