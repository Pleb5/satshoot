<script lang="ts">
    ...
    const checkboxInputClasses =
        ...
        'rounded-[4px] checked:bg-blue-500 checked:border-transparent peer';
</script>

<div
    class="rounded-[6px] overflow-hidden border-[1px] border-black-100 dark:border-white-100 px-[10px] py-[5px]"
>
